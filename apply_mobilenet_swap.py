...
new_phase1 = """# =====================================================================
# PYTORCH EXTREME REGULARIZATION TRAINING LOOP (MOBILENETV2)
# =====================================================================
...
# EXTREME WEIGHT DECAY: 5e-2 to crush memorization
# We train ALL parameters of MobileNetV2 since it's small enough!
optimizer = optim.AdamW(model.parameters(), lr=5e-4, weight_decay=5e-2) 

# Back to 50 Epochs so the smaller model has time to learn
EPOCHS = 50
...
print("Starting MobileNetV2 Extreme Regularization Training...")
